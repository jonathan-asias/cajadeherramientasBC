...
cd cajadeherramientasBC/SinBackend
```

> Si trabajas solo con la carpeta `SinBackend`, entra en ella antes de levantar el servidor local.
...
**Requisitos:** Node.js (solo para el servidor de desarrollo) y un navegador moderno.
...
├── data/
│   └── herramientas.json
├── img/                 # Imágenes generales y por herramienta
